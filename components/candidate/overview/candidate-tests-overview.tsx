...
import { CandidateTestCard } from "./candidate-test-card";

const PAGE_SIZE_OPTIONS = [4, 8, 16] as const;

type CandidateTestsOverviewProps = Readonly<{
...
export function CandidateTestsOverview({
  items,
  page,
  pageSize,
  query,
  ...
  function navigateWithParams(
    ...
    startTransition(() => {
      router.replace(`/candidate?${nextParams.toString()}`);
    });
  }
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between lg:gap-5">
        ...
        <div className="relative min-w-0 flex-1 lg:max-w-[621px]">
          <Input
